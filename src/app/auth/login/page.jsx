...
// Simple toast implementation (you can use react-toastify instead)
...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    if (error) {
      // Show toast for URL error and clean URL
      let errorMessage = "Authentication failed";
      if (error === 'unknown') errorMessage = "Something went wrong. Please try again.";
      if (error === 'access_denied') errorMessage = "Access denied. Please check your credentials.";
